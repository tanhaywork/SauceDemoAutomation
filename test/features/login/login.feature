Feature: User authentication
  ...
  Scenario: Unsuccessful login with invalid password
    ...
    Then The user should should error message "Username and password do not match any user in this service"
  ...
  Scenario: Unsuccessful login with user which is locked out
    ...
    Then The user should should error message "Sorry, this user has been locked out."
